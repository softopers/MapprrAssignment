...
import com.mapprr.githubassignment.api.ApiSuccessResponse
import com.mapprr.githubassignment.api.GithubService
import com.mapprr.githubassignment.api.RepoSearchResponse
...
import com.mapprr.githubassignment.util.RateLimiter
    ...
    fun search(query: String): LiveData<Resource<List<Repo>>> {
        return object : NetworkBoundResource<List<Repo>, RepoSearchResponse>(appExecutors) {
            ...
            override fun createCall() =
                githubService.searchRepos(query, "watchers_count", "desc", "10")
